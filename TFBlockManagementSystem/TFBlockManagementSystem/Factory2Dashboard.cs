using Factory2_Dashboard.Pages;
using System;
...
{
    public partial class Factory2Dashboard : Form
    {
        public Factory2Dashboard()
        {
            InitializeComponent();
            this.DoubleBuffered = true;
        }

        private void Factory2Dashboard_Load(object sender, EventArgs e)
        {
        ...
        {
            LoadPage(new RecordProduction2());
        }

        private void btnRaw_Click(object sender, EventArgs e)
        {
            LoadPage(new RawMaterialUsage2());
        }

        private void btnReport_Click(object sender, EventArgs e)
        {
            LoadPage(new Report2());
        }
